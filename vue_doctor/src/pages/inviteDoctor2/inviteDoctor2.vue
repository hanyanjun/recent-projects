    ...
    <div class="title">
      ...
      <div class="info">
        ...
        <div class="tip">
          <h6>我在智呼吸咨询平台</h6>
          <!--<i>诚挚邀请您加入这个专业平台</i>-->
          <p>欢迎加入智呼吸儿童咳喘和过敏专业化咨询平台，在这里您可免费建立自己的网上工作室，更加高效地管理您的会员！</p>
        </div>
      </div>
      <div class="qr">
        <img src="" alt="" v-img="qr">
        <p>长按或扫描二维码，进入个人工作室</p>
      </div>
    </div>
  ...
  export default{
    ...
    created(){
      ...
      if(!window.sessionStorage['reload']){
        window.location.href = `${DOCAUTHORIZELINK}?location_url=${id}/inviteDoctor2`
    ...
    computed:{
      ...
      qr(){
          return `${DOCLINKAPI}/doctor/platformInviteQRcode/${this.$route.params.id}`;
      }
    }
  }
</script>
  ...
  .container{
    .title{
      ...
      .info{
        ...
        padding: 1rem 0.34rem 0 0.24rem;
        box-sizing: border-box;
        display: flex;
        flex-wrap: nowrap;
        margin-top: 0.5rem;
